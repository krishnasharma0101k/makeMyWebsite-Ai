     ...
     <div className="sticky top-0 z-40 backdrop-blur-xl bg-black/50 border-b border-white/10">
             ...
             <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
               <div className="flex items-center gap-4">
                 ...
                 <h1 className="text-lg font-semibold">Make<span className=" text-zinc-400 font-normal">
                  MyWebsite</span></h1>
                 </div>
              ...
              <div className="max-w-6xl mx-auto px-6 py-16">
                ...
                >
                  <h1 className="text-4xl md:text-5xl font-bold mb-5 leading-tight">
                    ...
                    <span className="block bg-linear-to-r from-white to-zinc-400 bg-clip-text text-transparent">AI-Powered Websites</span>

                  </h1>
                  <p className="text-zinc-400  max-w-2xl mx-auto">
                   This process may be take several minutes.
                   MakeMyWebsite focuses on quality, not shortcuts.
                  </p>
                </motion.div>
                ...
                <div className="flex justify-center">
                  ...
                  className={`px-14 py-3 rounded-2xl font-semibold text-lg ${
                    prompt.trim() && !loading
                      ? "bg-white text-black"
