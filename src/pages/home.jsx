  ...
  return (
    <div className="relative min-h-screen bg-[#404040] text-white overflow-hidden">
                  ...
                  {openProfile && (
                    <>
                      <motion.div
                        ...
                        className="absolute right-0 mt-3 w-60 bg-[#0b0b0b] border border-white/10  shadow-2x1 z-50
                        overflow-hidden "
                      >
      ...
      <section className="pt-44 pb-32 px-6 text-center">
        ...
        >
          Describe It. Build It. Launch It. Turn your ideas into beautiful,
          high-converting, and fully responsive websites instantly. No code, no
          templates-just pure AI magic delivering production-ready results in
          seconds.
        </motion.p>

        <button
          className="px-10 py-4 rounded-xl bg-white text-black font-semibold hover:scale-105 transition mt-10"
          onClick={() => (userData ? navigate("/dashboard") : openLogin(true))}
        >
