...
function LoginModal ({open, onClose}) {
    ...
    return (
        ...
        {open && 
        <motion.div 
        className="fixed inset-0 z-100 flex items-center justify-center bg-black/80 backdrop-blur-xl px"
        initial = {{ opacity: 0}}
        animate = {{ opacity: 1}}
        exit = {{ opacity: 0}}
        onClick = {onClose}
        ...
        className="relative w-full max-w-md p-[1px] rounded-3xl bg-gradient-to-br from-purple-500/40 via-blue-500/30 to-transparent" onClick={(e) => e.stopPropagation()}>
        
        <div className="relative rounded-3xl bg-[#0b0b0b] border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden">
        ...
        className="absolute -top-32 -right-32 w-80 h-80 bg-blue-500/25 blur-[140px]"
        />
            ...
            <div className=" relative px-8 pt-14 pb-10 text-center">
                ...
                <h2 className="text-3xl font-semibold leading-thight mb-3 space-x-2">
                    <span>
                    Welcome to
                     </span>
