    ...
    <div className="min-h-screen bg-[#050505] text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <button className="px-4 py-2 rounded-lg bg-white text-black text-sm font-semibold hover:scale-105 transition" onClick={() => navigate("/generateWebsite")}>+ New Website</button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          >
            ...
            <h1 className="text-3xl fornt-bold">{userData.name}</h1>
          </motion.div>

          {loading && (
            <div className="mt-24 text-center text-zinc-400">Loading Your Website...</div>
          )}
